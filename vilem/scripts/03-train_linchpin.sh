...
sbatch_gpu "linchpin-bert-base-multilingual-cased" "comet-train --cfg $(get_config 'MiniLM' 'microsoft/Multilingual-MiniLM-L12-H384' 'linchpin-bert-base-multilingual-cased')"
