...
plt.plot(
    np.array(range(len(data_200[f"proxy_first_score"][10:])))+200*0.76/5.89,
...
plt.plot(
    np.array(range(len(data_50[f"proxy_first_score"][10:50])))+50*0.76/5.89,
...
plt.savefig(f"figures/results_multi_cost_{args.proxy}.pdf")
plt.show()