...
# python efficient_reranking/runtime_scripts/h5d_score_comet.py test efficient_reranking/runtime_scripts --comet_path "models/skintle-M/model/skintle-M-v20.ckpt" "--comet_batch_size" 200
